...
export interface PostActionBarProps {
  ...
  saved: boolean;
  onQuickReact: () => void;
  onReactionLongPress: (event: GestureResponderEvent) => void;
  onReactionLongPressMove: (event: GestureResponderEvent) => void;
  onReactionLongPressRelease: (event: GestureResponderEvent) => void;
  onCommentPress: () => void;
  onSavePress: () => void;
}
