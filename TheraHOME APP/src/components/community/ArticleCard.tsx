      ...
      <View style={styles.row}>
        <View style={styles.left}>
          <View style={styles.brandRow}>
            ...
            <Text style={[theme.type.caption, { color: theme.colors.textPrimary, fontFamily: theme.fontFamily.bold }]}>
              TheraHOME
            </Text>
            <View style={[styles.verifiedBadge, { backgroundColor: theme.colors.primary }]}>
              <Text style={styles.verifiedTick}>✓</Text>
            </View>
            <Text style={[theme.type.captionSm, { color: theme.colors.textMuted }]}> · {timeAgo(createdAt, t)}</Text>
          </View>
