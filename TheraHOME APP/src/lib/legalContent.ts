...
Ứng dụng không phải là dịch vụ y tế. Nội dung, bài tập, lộ trình phục hồi và phản hồi từ Trợ lý AI trong TheraHOME chỉ mang tính chất tham khảo, hỗ trợ, không thay thế cho chẩn đoán, tư vấn hoặc điều trị y tế từ bác sĩ, chuyên viên vật lý trị liệu có chuyên môn.
\t• Bạn nên tham khảo ý kiến bác sĩ hoặc chuyên viên trước khi bắt đầu bất kỳ chương trình phục hồi nào, đặc biệt nếu có bệnh lý nền.
...
TheraHOME là ứng dụng hỗ trợ theo dõi và phục hồi chức năng tại nhà. Vì Ứng dụng xử lý một số dữ liệu liên quan đến sức khoẻ (mức độ đau, tiến độ tập luyện), chúng tôi áp dụng các biện pháp bảo vệ chặt chẽ hơn mức thông thường cho các dữ liệu này, được mô tả xuyên suốt Chính sách.
2. Dữ liệu chúng tôi thu thập
2.1 Dữ liệu bạn cung cấp trực tiếp
\t• Thông tin tài khoản: họ tên, số điện thoại, email, mật khẩu (được mã hoá), ảnh đại diện.
\t• Hồ sơ sức khoẻ và phục hồi: mức độ đau bạn tự đánh giá theo từng ngày, vùng cơ thể/chương trình phục hồi bạn tham gia, ghi chú triệu chứng, tình trạng hoàn thành bài tập.
\t• Nội dung bạn đăng tải: bài viết, bình luận, ảnh trong mục Cộng đồng, tin nhắn gửi tới Trợ lý AI hoặc chuyên viên.
...
Nếu bạn cho phép, Ứng dụng có thể đọc hoặc ghi một số dữ liệu sức khoẻ và vận động thông qua HealthKit của Apple (ví dụ số bước đi, hoạt động vận động) để cá nhân hoá lộ trình phục hồi. Dữ liệu HealthKit chỉ được dùng cho mục đích quản lý sức khoẻ, thể chất và cải thiện trải nghiệm của bạn trong Ứng dụng.
...
\t• Xây dựng và cá nhân hoá lộ trình phục hồi, biểu đồ theo dõi mức đau và tiến độ.
...
\t• Vận hành Trợ lý AI để trả lời câu hỏi liên quan tới chương trình phục hồi.
...
\t• Nhà cung cấp mô hình AI của Trợ lý AI: nội dung bạn trao đổi có thể được gửi tới bên cung cấp dịch vụ AI để tạo phản hồi, theo hợp đồng bảo mật dữ liệu tương ứng.
\t• Chuyên viên phục hồi chức năng cộng tác với chúng tôi: khi bạn chủ động liên hệ hoặc yêu cầu tư vấn.
...
Cập nhật lần cuối: [Ngày ban hành / cập nhật gần nhất]
Mục Cộng đồng là nơi các thành viên TheraHOME chia sẻ hành trình phục hồi, động viên lẫn nhau và trao đổi kinh nghiệm. Quy định này áp dụng cho mọi bài viết, bình luận, hình ảnh và tương tác trong mục Cộng đồng, cùng với Điều khoản sử dụng và Chính sách quyền riêng tư.
1. Tinh thần chung
Cộng đồng TheraHOME được xây dựng trên sự tôn trọng và hỗ trợ lẫn nhau giữa những người đang trong quá trình phục hồi. Hãy chia sẻ như bạn muốn được đối xử: chân thành, tích cực và tôn trọng trải nghiệm của người khác.
2. Nên làm
...
\t• Spam, quảng cáo trái phép, liên kết ngoài không liên quan tới phục hồi chức năng.
