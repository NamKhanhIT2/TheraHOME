...
const GREETING = 'Xin chào! Tôi là Trợ lý AI TheraHOME. Tôi có thể giúp gì cho lộ trình phục hồi của bạn hôm nay?';
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <Pressable onPress={() => router.push('/chat/human')} style={styles.escalateBtn}>
          <Text style={[theme.type.captionSm, { color: theme.colors.textSecondary, textDecorationLine: 'underline' }]}>
            Cần hỗ trợ trực tiếp? Chat với Chuyên gia TheraHOME
          </Text>
        </Pressable>
