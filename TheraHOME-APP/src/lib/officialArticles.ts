...
export const TEST_BLOG_ARTICLE: OfficialArticle = {
  ...
  tag: 'Hướng dẫn',
  title: '5 nguyên tắc an toàn khi tập luyện tại nhà',
  ...
  body: [
    'Tập luyện tại nhà hiệu quả không đến từ việc tập càng nhiều càng tốt. Điều quan trọng là tập đúng hướng dẫn, đều đặn và biết lắng nghe phản ứng của cơ thể.',
    ...
    '3. Ghi nhận mức độ khó chịu mỗi ngày. Biểu đồ tiến trình giúp bạn và đội ngũ TheraHOME nhận ra xu hướng thay đổi thay vì chỉ dựa vào cảm giác của một ngày.',
    '4. Nghỉ ngắn khi cần và uống đủ nước. Một buổi tập nhẹ nhưng đúng kỹ thuật vẫn có giá trị cho quá trình tập luyện.',
    '5. Dừng tập và tham khảo ý kiến bác sĩ nếu cảm giác khó chịu tăng rõ rệt, xuất hiện yếu tay chân hoặc cảm giác bất thường kéo dài.',
...
const ENGLISH_TEST_BLOG_ARTICLE: OfficialArticle = {
  id: TEST_BLOG_ARTICLE_ID,
  tag: 'Guide',
  title: '5 safety principles for training at home',
  summary: 'Simple guidance to help you train at the right pace, monitor your body and maintain a safer training routine.',
  readTimeMinutes: 4,
  publishedAt: TEST_BLOG_ARTICLE.publishedAt,
  body: [
    'Effective home training is not about exercising as much as possible. What matters is following guidance, staying consistent and listening to your body’s response.',
    ...
    '3. Record your discomfort each day. Your progress chart helps you and the TheraHOME team notice trends instead of relying on how one day feels.',
    '4. Take short breaks when needed and drink enough water. A gentle session with good technique is still valuable for your training.',
    '5. Stop and consult your doctor if discomfort noticeably worsens, weakness develops in your arms or legs, or unusual sensations persist.',
...
const MALAY_TEST_BLOG_ARTICLE: OfficialArticle = {
  id: TEST_BLOG_ARTICLE_ID,
  tag: 'Panduan',
  title: '5 prinsip keselamatan untuk latihan di rumah',
  summary: 'Panduan ringkas untuk membantu anda berlatih mengikut rentak yang sesuai, memantau tubuh dan mengekalkan rutin latihan yang lebih selamat.',
  readTimeMinutes: 4,
  publishedAt: TEST_BLOG_ARTICLE.publishedAt,
  body: [
    ...
    '4. Berehat seketika apabila perlu dan minum air secukupnya. Sesi ringan dengan teknik yang betul tetap bernilai untuk latihan anda.',
    '5. Hentikan latihan dan rujuk doktor jika ketidakselesaan semakin teruk, tangan atau kaki menjadi lemah, atau sensasi luar biasa berterusan.',
